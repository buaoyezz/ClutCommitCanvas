...
class AboutPage(QWidget):
    ...
    def setup_ui(self):
        ...
        logo_card = ClutImageCard(
            ...
            msg="一个基于PyQt-ClutUI框架开发的Git提交辅助工具 | 作者: ZZBuAoYe",
        ...
        github_card.mousePressEvent = partial(
            self.open_url, 
            "https://github.com/ZZBuAoYe/ClutCommitCanvas"
        )
        ...
        license_card.mousePressEvent = partial(
            self.open_url,
            "https://github.com/ZZBuAoYe/ClutCommitCanvas/blob/main/LICENSE"
        )
        ...
        copyright_card = ClutCard(
            title="本框架版权声明",
            msg="PyQt-ClutUI x ClutCommitCanvas 版权所有 © 2024 by ZZBuAoYe\n保留所有权利"
        )
